								...
								<div class="intro-caption-holder">
									<div class="intro-caption row center flx-c">
                                        ...
                                        <div class="intro-buttons">
                                            <a href="#" class="btn btn-primary margin-top-5 margin-right-10" target="_blank">Lets Get in Touch</a> 
                                            <a href="#" class="btn btn-white-bordered margin-top-5">Learn More</a>
                                        </div>
                                        </div>
                                        <div class="col-md-6">
								...
								<div class="tt-heading-inner">
									...
									* Use classes "zig-zag-light" or "zig-zag-dark" to change zig-zag separator style.
									...
									<div class="tt-heading-text">
										Repellendus nihil exercitationem illo molestias voluptatum fugit omnis tare. Voluptate modi, deserunt ipsam. <a href="#" target="_blank">View All Clients</a>
									</div>
