<div>
    <!-- ========================
			...
			* Use class "ph-center" or "ph-right" to align page header caption.
			-->
			<section id="page-header" class="ph-sm vertex-cs">
				...
				* Use class "hide-ph-image" to hide page header image without removing the code.
				...
				<div class="page-header-image bg-image hide-ph-image" style="background-image: url(assets/img/portfolio/vertex-pay/cta-1.png);">
					...
					* Use class "cover-gradient-dark", "cover-gradient-light" or "cover-gradient-color" to enable cover gradient background.
					-->
					<div class="cover cover-opacity-8 cover-gradient-dark"></div>
					...
					<div class="row flx-c cta-column-reverse">
							...
							<div class="page-header-caption ph-cap-sm ph-cap-shadow mb-3 parallax-5 fade-out-scroll-4">
								<div>
									<div class="ph-subtitle-wrap">
										<h2 class="page-header-subtitle">Building a Digital Banking System</h2>
									</div>
									<div class="ph-title-wrap">
										<h1 class="page-header-title">Digital Banking</h1>
									</div>
						...
						<div class="col-md-6 center">
							<div class="m-auto mb-3 parallax-5 fade-out-scroll-4" style="max-width: 650px; width: 100%;">
								<img src="{{asset('assets/img/portfolio/vertex-pay/cta-super-dark.png')}}" alt="">
							</div>
						</div>
					</div>
				...
				* Use class "hide-ph-anim" to disable animated element without removing the code.
				...
				<div class="ph-anim-element-wrap ph-anim-circle parallax-4 fade-out-scroll-4" style="z-index: -3;">
					<div class="ph-anim-element-holder">
						<div class="ph-anim-element ph-anim-element-red"></div>
					</div>
				</div>
                ...
                <div class="row skills">
					<div class="col-md-6">
						<ul class="p-0 list-none" style="list-style: none; padding: 0;">
							...
							<li><h6><b>Client:</b><span class="text-primary mx-2 fw-200" >Vertex Pay LTD</span></h6></li>
							<li><h6><b>Industry:</b><span class="text-primary mx-2">Financial Industry</span></h6></li>
							<li><h6><b>Role: </b><span class="text-primary mx-2">UI/UX and Frontend Web Development</span></h6></li>
					...
					<div class="col-md-6">
						<ul style="list-style: none; padding: 0;">
							...
							<li><img src="{{asset('assets/img/logo/sass.svg')}}" class="object-fit-contain w-24 h-24 mx-2" alt="html5"><h6 class="display-inline-block text-primary">SASS</h6></li>
							<li><img src="{{asset('assets/img/logo/javascript.svg')}}" class="object-fit-contain w-24 h-24 mx-2" alt="html5"><h6 class="display-inline-block text-primary">JS</h6></li>
							<li><img src="{{asset('assets/img/logo/github.svg')}}" class="object-fit-contain w-24 h-24 mx-2" alt="html5"><a href="https://github.com/peruclarice/vertexPay"><h6 class="display-inline-block text-primary">Open Source Code</h6></a></li>
						</ul>
					</div>
				</div>
            </div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="white-bx-shadow">
					<embed src="{{asset('assets/img/portfolio/vertex-pay/VPAYNew Mockup Iteration 2.pdf')}}" type="application/pdf" width="100%" height="500px"/>
				</div>
			</div>
		</div>
    </div>
    ...
    <div class="py-5 mb-4">
        ...
        <div>
            ...
            <div class="p-4" style="text-align: center;">
				<img src="{{asset('assets/img/portfolio/style guide.png')}}" alt="" style="max-width: 450px; width: 100%;">
			</div>
        </div>
    </div>
</section>
				...
				<div class="isotope-items-wrap">
					...
					* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
					...
					<div class="isotope-item digital iso-height-1">
						...
						<figure class="portfolio-single-image-holder">
							<a href="assets/img/portfolio/vertex-pay/1.png" class="ps-image-link lg-trigger" data-exthumbnail="assets/img/portfolio/vertex-pay/thumb/1-thumb.png" data-sub-html="Yes, you can use image captions. :)">
								<div class="portfolio-single-image bg-image lazy" data-src="assets/img/portfolio/vertex-pay/1.png">
					...
					* If you use background image on isotope-item child element, then you need to use class "iso-height-1" or "iso-height-2" to set the item height. If you use simple image tag, then don't use height classes.
					...
					<div class="isotope-item digital iso-height-2">
						...
						<!-- Begin portfolio single image -->
						<figure class="portfolio-single-image-holder">
							<a href="assets/img/portfolio/vertex-pay/2.png" class="ps-image-link lg-trigger" data-exthumbnail="assets/img/portfolio/vertex-pay/1.png">
								<div class="portfolio-single-image bg-image lazy" data-src="assets/img/portfolio/vertex-pay/1.png">
									<div class="ps-image-icon">
										<span class="lnr lnr-eye"></span>
									</div>
