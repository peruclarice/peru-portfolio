			...
			* Use class "intro-full-m" to set intro size for small screens only.
			...
			<section id="portfolio-list-section">
				...
				* Use classes "tt-heading-xs", "tt-heading-sm", "tt-heading-lg", "tt-heading-xlg" or "tt-heading-xxlg" to set tt-heading size.
				...
				<!-- End tt-heading -->
				{{-- <div class="case-study-container case-study-grid"></div> --}}
                <div class="case-study-container row">
					<div class="col-md-6">
						<div class="card bg-transparent border-0">
							<div class="card-header bg-transparent">
								<h2 class="card-title">UI/UX Case Studies</h2>
							</div>
			...
			<div style="padding: 2rem 1rem;">
				<div class="row flx flx-c" style="align-items: center;">
					...
					<div class="col-md-6">
						<div class="card bg-transparent border-0">
							<div class="card-header bg-transparent">
								<h2 class="card-title">Frontend Case Studies</h2>
							</div>
							<div class="card-body p-0">
